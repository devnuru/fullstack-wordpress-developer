...
class Search {
  ...
  // getResults() {
  //   fetch(
  //     `http://fictionaluniversity.local/wp-json/wp/v2/posts/?search=${searchField.value}`
  //   )
  //     .then((res) => res.json())
  //     .then((out) => {
  ...
  keyPressDispatcher(e) {
    ...
    if (e.keyCode == 83 && !this.isOverlayOpen && !jquery__WEBPACK_IMPORTED_MODULE_0___default()("input, textarea").is(":focus")) this.openOverlay();
