...
function university_files() {
    wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=hjdcjdcnjk578903hjdnhjxx', NULL , '1.0', true );
...
function universityMapKey() {
  $api['key'] = 'hjcvmckoauiHYUdj8i832s2ddjJYHydRdw';
  return $api;
}
...
// Redirect subscriber accounts out of the admin 
